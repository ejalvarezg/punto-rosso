...
#app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:@localhost/punto-rosso"
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://.mysql.pythonanywhere-services.com/___$___"
...
class Producto(db.Model):  # Producto hereda de db.Model
    ...
    def __init__(self, nombre, precio, stock, celiaco):
        """
...
class ProductoSchema(ma.Schema):
    ...
    """
    class Meta:
        fields = ("id", "nombre", "precio", "stock", "celiaco")
...
'''
@app.route("/productos/busqueda/<string:texto>", methods=["GET"])
...
def create_producto():
    ...
    celiaco = request.json["celiaco"]  # Obtiene la imagen del producto del JSON proporcionado
    new_producto = Producto(nombre, precio, stock, celiaco)  # Crea un nuevo objeto Producto con los datos proporcionados
...
def update_producto(id):
    ...
    producto.celiaco = request.json["celiaco"]
